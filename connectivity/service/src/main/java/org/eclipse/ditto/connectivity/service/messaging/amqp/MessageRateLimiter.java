...
final class MessageRateLimiter<S> {
    ...
    /**
     *Returns whether rate limiter is enabled.
    ...
    /**
     *Returns how many messages were consumed within this period.
    ...
    /**
     *Returns maximum number of messages we are allowed to consume within this period.
    ...
    /**
     *Returns current number of unacknowledged messages and messages expected to be redelivered.
    ...
    /**
     *Returns the number of messages expected to be redelivered.
    ...
    /**
     *Returns maximum number of unacknowledged messages and messages expected to be redelivered.
    ...
    /**
     *Returns after how long to forget about a pending unacknowledged message (could be consumed by someone else).
    ...
    /**
     *Returns whether the consumer is known to be open.
    ...
    /**
     *Returns whether the number of messages consumed exceeded the maximum.
    ...
    /**
     *Returns whether the number of unacknowledged/to-be-redelivered messages exceeded the maximum (e. g.,
